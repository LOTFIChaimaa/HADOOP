...
public class Gestion implements Serializable {
	...
	public List<String> serverUrl = new ArrayList<String>();
	...
	public void getStructure() throws PropretyInvalideException {
		...
		try {
			FileInputStream isPorts = new FileInputStream("hidoop/data/hdfsclientinfo/portNoeud.url");
			proprietePorts.load(isPorts);
			isPorts.close();
			
			FileInputStream isConf = new FileInputStream("hidoop/data/hdfsclientinfo/confStructure.conf");
			proprieteConfig.load(isConf);
			isConf.close();
			
			FileInputStream isWorker = new FileInputStream("hidoop/data/hdfsclientinfo/listWorkerURL.listeurl");
			proprieteWorkers.load(isWorker);
			isWorker.close();
			
			
			FileInputStream isServ = new FileInputStream("hidoop/data/hdfsClient/serveurHDFS.listeurl");
